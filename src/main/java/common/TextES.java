...
public final class TextES {
	...
	private static final String buttonNewMailSendListenerEncoding = "UTF-8";
	...
	private static final String buttonNewMailSendListenerHeaderPropertiy = "X-Mailer";
	private static final String buttonNewMailSendListenerHeaderValue = "smtpsend";
	...
	private static final String emailStringNewMail = "Crear mensaje";
	private static final String emailStringSend = "Enviar";
	private static final String emailStringCancel = "Cancelar";
	private static final String emailStringSubject = "Asunto";
	private static final String emailStringFrom = "Remitente";
	private static final String emailStringTo = "Destinatario";

	private static final String ftpcreateStringConfirm = "Confirmar";
	private static final String ftpStringUpload = "Subir archivo";
	private static final String ftpStringDownload = "Bajar archivo";
	...
	private static final String mailContainerPropertiesPortValue = "993";
	private static final String mailContainerPropertiesProtocolProperty = "mail.store.protocol";
	private static final String mailContainerPropertiesProtocolValue = "imap";
	private static final String mailContainerPropertiesSocketFactoryFallbackProperty = "mail.imap.socketFactory.fallback";
	private static final String mailContainerPropertiesSocketFactoryFallbackValue = "false";
	private static final String mailContainerPropertiesSocketFactoryPortProperty = "mail.imap.socketFactory.port";
	private static final String mailContainerPropertiesSocketFactoryPortValue = "993";
	private static final String mailContainerPropertiesSSLSocketFactoryClassProperty = "mail.imap.socketFactory.class";
	private static final String mailContainerPropertiesSSLSocketFactoryClassValue = "javax.net.ssl.SSLSocketFactory";
	private static final String mailContainerDateFormat = "dd-MM-yyyy HH:mm";

	private static final String mainStringFTP = "FTP";
	private static final String mainStringMail = "Correo";
	private static final String mainStringDisconnect = "Desconectar";
	private static final String mainStringTitle = "Principal";

	private static final String signinStringUserName = "Usuario";
	private static final String signinStringName = "Nombre";
	private static final String signinStringSurname = "Apellidos";
	private static final String signinStringTeacher = "¿Eres Profesor?";
	private static final String signinStringEmail = "Correo Electrónico";
	...
	public static String getButtonnewmailsendlistenerencoding() {
		return buttonNewMailSendListenerEncoding;
	}
	...
	public static String getButtonnewmailsendlistenerheaderpropertiy() {
		return buttonNewMailSendListenerHeaderPropertiy;
	}
	public static String getButtonnewmailsendlistenerheadervalue() {
		return buttonNewMailSendListenerHeaderValue;
	}
	...
	public static String getMailContainerPropertiesHostValue() {
		return mailContainerPropertiesHostValue;
	}
	public static String getMailContainerPropertiesPortProperty() {
		return mailContainerPropertiesPortProperty;
	}
	public static String getMailContainerPropertiesPortValue() {
		return mailContainerPropertiesPortValue;
	}
	public static String getMailContainerPropertiesProtocolProperty() {
		return mailContainerPropertiesProtocolProperty;
	}
	public static String getMailContainerPropertiesProtocolValue() {
		return mailContainerPropertiesProtocolValue;
	}
	public static String getMailContainerPropertiesSocketFactoryFallbackProperty() {
		return mailContainerPropertiesSocketFactoryFallbackProperty;
	}
	public static String getMailContainerPropertiesSocketFactoryFallbackValue() {
		return mailContainerPropertiesSocketFactoryFallbackValue;
	}
	public static String getMailContainerPropertiesSocketFactoryPortProperty() {
		return mailContainerPropertiesSocketFactoryPortProperty;
	}
	public static String getMailContainerPropertiesSocketFactoryPortValue() {
		return mailContainerPropertiesSocketFactoryPortValue;
	}
	public static String getMailContainerPropertiesSSLSocketFactoryClassProperty() {
		return mailContainerPropertiesSSLSocketFactoryClassProperty;
	}
	public static String getMailContainerPropertiesSSLSocketFactoryClassValue() {
		return mailContainerPropertiesSSLSocketFactoryClassValue;
	}
	public static String getMailContainerDateFormat() {
		return mailContainerDateFormat;
	}
