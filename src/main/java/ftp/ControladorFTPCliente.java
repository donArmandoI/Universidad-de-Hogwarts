...
public class ControladorFTPCliente {
	...
	public ControladorFTPCliente(Usuario user, Socket cli, FTPClient ftpClient) {

	}

	public ControladorFTPCliente(Usuario user, Socket cli) {
		...
		try {
			...
			if (login) {
				...
				vista.setMainJpanelPanel(vistaFTP);

				vista.setVisible(true);

				vista.addWindowListener(win);
